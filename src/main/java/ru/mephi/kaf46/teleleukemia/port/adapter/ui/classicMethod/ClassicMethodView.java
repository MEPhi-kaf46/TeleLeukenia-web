...
public class ClassicMethodView extends VerticalLayout {

    Grid<Kafedra> grid = new Grid<>(Kafedra.class);
    TextField filterText = new TextField();
    ClassicMethodForm form;
    
    ClassicMethodService classicMethodService;

    public ClassicMethodView(ClassicMethodService classicMethodService) {
    ...
    private void configureForm() {
        form = new ClassicMethodForm(this.classicMethodService);
        form.setWidth("25em");
    }
